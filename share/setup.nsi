...
!define URL http://www.TulipMania.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/TulipMania.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\TulipMania-qt.exe
...
OutFile TulipMania-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/TulipMania-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/TulipManiad.exe
    ...
    #Delete /REBOOTOK $INSTDIR\TulipMania.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\TulipMania-qt.exe
