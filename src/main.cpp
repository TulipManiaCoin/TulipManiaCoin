...
unsigned int nTargetSpacing = 1 * 30; // TulipMania - 0.5 minute blocks
...
unsigned int nModifierInterval = 10 * 60; // TulipMania - time to elapse before new modifier is computed
...
const string strMessageMagic = "TulipMania Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TulipMania", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "https://www.ccn.com/brave-browser-files-gdpr-complaint-against-google-dumps-search-engine/";
        CTransaction txNew;
        txNew.nTime = 1536865607;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1536865607;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 17956506;
        ...
        assert(block.hashMerkleRoot == uint256("a15da29c32c48d38bd963041b3152d956040124d4b8f19236190bcdcc2dfd6d0"));
