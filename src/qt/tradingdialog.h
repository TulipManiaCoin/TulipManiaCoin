...
private slots:
    ...
    void on_BuyTulipMania_clicked();
    void on_SellTulipManiaBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputTulipMania_textChanged(const QString &arg1);
    ...
    QString BuyTulipMania(QString OrderType, double Quantity, double Rate);
    QString SellTulipMania(QString OrderType, double Quantity, double Rate);
